...
* Поле та можливість його зміни
* Ручна та автоматична розстановки
* Два режима складності
* Графічний інтерфейс
* Система акаунтів
* Налаштування до кожного з аккаунтів
* Сейви до кожного з аккаунтів
* Демонстраційний режим
* Можливість продовжити гру
* Додати статистику
* Додати можливість скидання налаштувань
