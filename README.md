...
Також там скидається параметр "difficulty".

Додатково реалізовано меню статистики, але опис вже і без того досить великий, тому його ми пропустимо. Але якщо є бажання, його можна побачити в [FinalProject](FinalProject/Menu.cpp)
